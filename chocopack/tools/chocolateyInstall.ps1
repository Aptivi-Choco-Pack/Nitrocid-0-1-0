...
$pkgName    = "KS"
$url        = "https://github.com/Aptivi/NitrocidKS/releases/download/v0.1.0.4/0.1.0.4-bin.zip"
$shacheck   = "77684ccfec0597ff98e0a4e35f22c8fc0c5d292987cbe548cdbc0f9601da4a92"
