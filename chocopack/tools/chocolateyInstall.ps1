...
$pkgName    = "KS"
$url        = "https://github.com/Aptivi/NitrocidKS/releases/download/v0.1.0.11/0.1.0.11-bin.zip"
$shacheck   = "2984cf8e789ed3453aacb4e613ad782bb6684cdb4550c974fdad16f341e42ffa"
