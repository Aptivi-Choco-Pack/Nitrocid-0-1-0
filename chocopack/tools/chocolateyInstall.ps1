...
$pkgName    = "KS"
$url        = "https://github.com/Aptivi/NitrocidKS/releases/download/v0.1.0.14/0.1.0.14-bin.zip"
$shacheck   = "e6336faa509578f6852657475cdaed7c0dda7bad22776798be367f56d76594be"
