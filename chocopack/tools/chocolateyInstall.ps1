...
$pkgName    = "KS"
$url        = "https://github.com/Aptivi/NitrocidKS/releases/download/v0.1.0.7/0.1.0.7-bin.zip"
$shacheck   = "f322c71bf9d974fab2dd373efaa6b7c450bbcd9d0dadfe0d18864a3322fddbbb"
