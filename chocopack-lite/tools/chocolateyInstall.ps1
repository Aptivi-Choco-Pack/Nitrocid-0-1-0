...
$pkgName    = "kslite"
$url        = "https://github.com/Aptivi/NitrocidKS/releases/download/v0.1.0.8/0.1.0.8-bin-lite.zip"
$shacheck   = "27ae4d99d801d8461a8c5d6f8a3a9b04b4a027b1617ba7c5896711f218c9d3c8"
