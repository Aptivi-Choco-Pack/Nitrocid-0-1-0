...
$pkgName    = "kslite"
$url        = "https://github.com/Aptivi/NitrocidKS/releases/download/v0.1.0.6/0.1.0.6-bin-lite.zip"
$shacheck   = "a53c02201543aeecf975e6fbe137b2a8409eee8590701746bebb9aa36e1b52af"
