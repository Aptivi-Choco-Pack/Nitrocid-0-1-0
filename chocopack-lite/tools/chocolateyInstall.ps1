...
$pkgName    = "kslite"
$url        = "https://github.com/Aptivi/NitrocidKS/releases/download/v0.1.0.4/0.1.0.4-bin-lite.zip"
$shacheck   = "289939d3bfa06ba7b0c07fcd1342aff806acb3d099ffff759f179631e11721b7"
